# Dockerfile for PHP (FPM 7.0.27, HHVM 3.x.y) built for PHP/Nginx DNA Project Base docker-stack
# ===============================================================
#   docker build -t neam/dna-project-base-debian-php:1.0.0 .
#   docker push neam/dna-project-base-debian-php:1.0.0
